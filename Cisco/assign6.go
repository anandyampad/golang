...
*/
func IndexOf(products []Product, product Product) (int, error) {
...
func Any(products []Product, spec Specification) bool {
...
func All(products []Product, spec Specification) bool {
	for _, v := range products {
		if !spec.IsSatisfied(&v) {
			return false
		}
